...
CREATE ALIAS AGE FOR "com.github.hofls.hiber.storage.sql_file_report.VisitCountTest.age";
-- there is "DATE_PART" function in POSTGRES, but there is no such function in H2DB, so lets create one
CREATE ALIAS DATE_PART FOR "com.github.hofls.hiber.storage.sql_file_report.VisitCountTest.datePart";
