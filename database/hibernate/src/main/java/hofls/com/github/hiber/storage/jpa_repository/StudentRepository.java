...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    @Query(value = "SELECT s FROM Student s WHERE :studentIds is null OR s.id IN (:studentIds) ")
    ...
    @Query(nativeQuery = true, value = "select * from student where :status is null OR status = :status")
