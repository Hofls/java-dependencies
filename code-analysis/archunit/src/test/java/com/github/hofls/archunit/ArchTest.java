package com.github.hofls.archunit;
...
class ArchTest {
    ...
    void archUnit_MainClasses() {
        JavaClasses classes = new ClassFileImporter()
            ...
            .importPackages("com.github.hofls.archunit");
        ...
        noClasses()
            .that()
                .resideInAnyPackage("com.github.hofls.archunit.service..")
            .or()
                .resideInAnyPackage("com.github.hofls.archunit.repository..")
            .should().dependOnClassesThat()
                .resideInAnyPackage("com.github.hofls.archunit.web..")
