package com.github.hofls.rest.same.name;


import com.github.hofls.rest.same.name.types.ResponseA;
import com.github.hofls.rest.same.name.types.ResponseB;
import com.github.hofls.rest.same.name.types.ResponseC;
